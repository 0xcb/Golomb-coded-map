...
With a false positive chance above 9.5%, give or take, the GCM is larger than a Bloom filter because adding 1.5 results in a larger value than multiplying by 1.44. But the smaller the false positive chance, the more the GCM approaches the information-theoretic minimum. At a false positive rate of 1 in 2<sup>40</sup> (false positive chance of 0.00000000000091%), for example, the Bloom filter needs 57.71 bits per entry, while the GCM needs only 41.5.
